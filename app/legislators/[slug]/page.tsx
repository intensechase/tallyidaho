        ...
        <div className="md:col-span-2 space-y-8">
          ...
          {primaryBills.length > 0 && (
            <section>
              ...
              <BillList bills={primaryBills} year={session?.year_start || 2026} />
            </section>
          )}
          ...
          {coBills.length > 0 && (
            <section>
              ...
              <BillList bills={coBills} year={session?.year_start || 2026} />
            </section>
          )}
          ...
          {prevSession && prevBills.length > 0 && (
            <section>
              <details className="group">
                ...
                <BillList bills={prevBills} year={prevSession.year_start} />
              </details>
            </section>
          )}
