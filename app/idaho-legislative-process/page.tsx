...
export const metadata: Metadata = {
  title: 'How Idaho Laws Are Made — Idaho Legislature Guide | Tally Idaho',
  description: 'A plain-language guide to the Idaho legislative process: how a bill becomes law, what legislative terms mean, and how to read voting records on Tally Idaho.',
  alternates: { canonical: 'https://www.tallyidaho.com/idaho-legislative-process' },
  openGraph: {
    title: 'How Idaho Laws Are Made — Idaho Legislature Guide',
    description: 'Step-by-step guide to the Idaho legislative process, from bill introduction to the Governor\'s signature.',
    url: 'https://www.tallyidaho.com/idaho-legislative-process',
...
export default function IdahoLegislativeProcessPage() {
  const faqJsonLd = {
  ...
  const howToJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'How a Bill Becomes Law in Idaho',
    description: 'A step-by-step guide to the Idaho legislative process, from bill introduction to the Governor\'s signature.',
